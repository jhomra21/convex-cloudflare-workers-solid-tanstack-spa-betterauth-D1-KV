            ...
            <SidebarProvider>
              <div class="flex h-screen w-screen overflow-hidden bg-muted/40">
                ...
                <SidebarInset class="flex-grow min-w-0 bg-background rounded-xl shadow-md transition-all duration-150 ease-in-out flex flex-col">
                  <header class={`flex h-16 shrink-0 items-center rounded-t-xl gap-2 border-b border-gray-200 dark:border-gray-700 bg-background/95 backdrop-blur-sm sticky top-0 z-20 md:relative md:z-10 transition-shadow duration-150 will-change-scroll-position ${isScrolled() ? 'shadow-md' : ''}`}>
                  ...
                  <div class={`absolute top-16 left-0 right-0 h-6 bg-gradient-to-b from-background/50 to-transparent pointer-events-none z-30 transform transition-transform duration-200 will-change-transform ${isScrolled() ? 'translate-y-0' : 'translate-y-[-100%]'}`}></div>
