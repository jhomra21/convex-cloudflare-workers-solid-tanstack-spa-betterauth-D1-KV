            ...
            >
                <Tooltip openDelay={500}>
                    ...
                    <TooltipContent>
                        <p>
                            {
                                !!props.activeCanvasId ? "Shared Canvas" : // Collaborator on shared canvas
                                    (!props.activeCanvasId && !!props.currentCanvas?.isShareable) ? "Sharing Enabled" : // Owner sharing their canvas
                                        "Share Canvas" // Not shared
                            }
                        </p>
                    </TooltipContent>
                </Tooltip>
