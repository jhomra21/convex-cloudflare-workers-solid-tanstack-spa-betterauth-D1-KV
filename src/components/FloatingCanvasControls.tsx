    ...
    <>
      ...
      >
        <div
          ...
          style={{
            "max-height": isMinimized() ? "40px" : "200px",
        ...
        >
          ...
          >
            ...
            <span class="text-xs font-mono text-muted-foreground min-w-[45px] text-center">
          ...
          <div 
            ...
            style={{
              ...
              "animation": !isMinimized() ? "controls-fade-slide 250ms ease-out forwards" : "none"
            }}
          >
            {/* Zoom controls */}
